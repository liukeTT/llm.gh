...
.PHONY: all train_gpt2 test_gpt2 train_gpt2cu train_gpt2cu_gh test_gpt2cu train_gpt2fp32cu test_gpt2fp32cu profile_gpt2cu stats_gpt2cu
...
ifeq ($(NVCC),)
    ...
    TARGETS += train_gpt2cu train_gpt2cu_gh test_gpt2cu train_gpt2fp32cu test_gpt2fp32cu $(NVCC_CUDNN)
endif
...
train_gpt2cu_gh: train_gpt2_gh.cu $(NVCC_CUDNN)
	$(NVCC) $(NVCC_FLAGS) $(PFLAGS) $^ $(NVCC_LDFLAGS) $(NVCC_INCLUDES) $(NVCC_LDLIBS) $(CUDA_OUTPUT_FILE)
...
stats_gpt2cu: stats_gpt2.cu $(NVCC_CUDNN)
	$(NVCC) $(NVCC_FLAGS) $(PFLAGS) -lineinfo $^ $(NVCC_LDFLAGS) $(NVCC_INCLUDES) $(NVCC_LDLIBS)  $(CUDA_OUTPUT_FILE)
